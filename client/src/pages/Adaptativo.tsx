...
const FAQS = [
  { q: "¿Barkley Adaptativo es una terapia o tratamiento?", a: "No. Es un formato de estudio que se acomoda a cómo aprende tu hijo — no una terapia ni un tratamiento clínico. El acompañamiento profesional (psicopedagogo, terapeuta ocupacional, neurólogo) sigue siendo el de tu confianza; Barkley no lo reemplaza." },
...
export default function Adaptativo() {
  ...
  useEffect(() => {
    document.title = "Barkley Adaptativo — Colegio online para niños con TDAH, dislexia y otros ritmos | Barkley Online";
    const desc = document.querySelector('meta[name="description"]');
    if (desc) desc.setAttribute("content", "Barkley Adaptativo: educación online 100% asincrónica para niños con TDAH, dislexia u otro ritmo de aprendizaje. Técnicas reales: microaprendizaje, refuerzo dirigido, formato dual video+pódcast. Preparación oficial para Exámenes Libres MINEDUC en Chile.");
  }, []);
      ...
      <section style={{ background: PURPLE, color: "#fff", padding: "64px 24px 56px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <p style={{ color: GOLD, fontSize: 13, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", margin: "0 0 12px" }}>
            Barkley Adaptativo · 1° básico a 4° medio
          </p>
      ...
      <section style={{ padding: "64px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 13.5, color: "#8a8a8a", maxWidth: 620, margin: "28px auto 0", textAlign: "center" }}>
            Barkley Adaptativo no reemplaza el diagnóstico ni el tratamiento profesional de tu hijo —
      ...
      <section style={{ background: "#f5f5f5", padding: "56px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <a href="/#inscripcion" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#FF3D37", color: "#fff", fontWeight: 700, fontSize: 15, padding: "14px 30px", borderRadius: 999, textDecoration: "none" }}>
            Reservar cupo en Barkley Adaptativo <ArrowRight style={{ width: 16, height: 16 }} />
          </a>
        </div>
      </section>
