...
const PILARES = [
  ...
  { title: "Metodología", img: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=700&q=75", text: "Cada unidad se desbloquea solo si dominas la anterior: video corto, práctica, y si te cuesta, refuerzo antes de seguir. Sin saltos, sin huecos — avanzas cuando de verdad aprendiste, no cuando pasó el tiempo." },
